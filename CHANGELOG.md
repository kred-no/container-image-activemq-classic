...
## 2026-08-11
  * **TEMURIN**
    ...
    * Updated Postgres JDBC version: 42.7.13 ([RR])
    * Updated Ansible builder image version: 2.21.0 ([RR])
  * **DEBIAN**
    * Added ActiveMQ build: 6.3.1 ([RR])
    * Updated Postgres JDBC version: 42.7.13 ([RR])
...
## 2026-03-24
  * **IMPROVEMENTS**
    * Updated ActiveMQ version from 6.1.7 => 6.2.1 ([RR])
    * Added temurin-build, based on official image ([RR])
    * Re-structured folders ([RR])
    * Added hawtio compose-example ([RR])
    * Updated Readme
